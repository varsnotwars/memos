...
// MemoRelationFilterCELAttributes are the CEL attributes for user.
var MemoRelationFilterCELAttributes = []cel.EnvOption{
	cel.Variable("memo_id", cel.StringType),
	cel.Variable("memo_relation_id", cel.StringType),
}
